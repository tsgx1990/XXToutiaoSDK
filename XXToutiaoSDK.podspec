...
Pod::Spec.new do |s|
  ...
  s.name         = "XXToutiaoSDK"
  s.version      = "0.0.1"
  s.summary      = "A short description of XXToutiaoSDK."
  ...
  s.homepage     = "http://EXAMPLE/XXToutiaoSDK"
  ...
  s.author             = { "luguanglong" => "luguanglong@syswin.com" }
  ...
  s.source       = { :git => "http://EXAMPLE/XXToutiaoSDK.git", :tag => "#{s.version}" }
